...
public:
    ...
    //std::map<int, FunctionDefineInstruction*> function_funcDefIns_map;
    ...
    // FunctionDefineInstruction* GetFuncDefIns(int now_function)
    // {
    //     return function_funcDefIns_map[now_function];
    // }
