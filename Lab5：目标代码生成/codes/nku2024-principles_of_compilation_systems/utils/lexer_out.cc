...
void PrintLexerResult(std::ostream &s, char *yytext, YYSTYPE yylval, int token) {
    ...
    case '<':
        ...
        break;
    case ADDASSIGN:
        ALIGNED_FORMAT_OUTPUT("ADDASSIGN", yytext, "");
        break;
    case SUBASSIGN:
        ALIGNED_FORMAT_OUTPUT("SUBASSIGN", yytext, "");
        break;
    case MULASSIGN:
        ALIGNED_FORMAT_OUTPUT("MULASSIGN", yytext, "");    
        break;
    case DIVASSIGN:
        ALIGNED_FORMAT_OUTPUT("DIVASSIGN", yytext, "");    
        break;
    case MODASSIGN:
        ALIGNED_FORMAT_OUTPUT("MODASSIGN", yytext, "");
        break;
