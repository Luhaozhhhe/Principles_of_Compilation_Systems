...
static const yytype_int16 yypgoto[] =
{
    ...
    -172,  -172,   102,   -36,    14,  -172,    62,    66,   227,   -29,
     -46,   229,  -172
};
...
static const yytype_uint8 yytable[] =
{
     ...
     124,   198,    54,   199,   200,    86,   159,   201,   202,    56,
      ...
      25,    73,    50,    51,    52,    53,   133,   160,   117,   213,
     118,    83,   212,   180,    80,   121,   122,   123,    82,     0,
...
static const yytype_int16 yycheck[] =
{
     ...
     196,   197,     3,     4,     5,     6,    33,    31,    32,    36,
      ...
      13,    33,     3,     4,     5,     6,    88,   128,    19,   197,
      21,    41,   196,   154,    37,    26,    27,    28,    39,    -1,
...
#line 2490 "SysY_parser.tab.c"
    break;

  case 110: /* ArrayDim: '[' Exp ']'  */
#line 817 "parser/SysY_parser.y"
{
    (yyval.expression) = (yyvsp[-1].expression);
    (yyval.expression)->SetLineNumber(line_number);
}
#line 2499 "SysY_parser.tab.c"
    break;

  case 111: /* ArrayDim_list: ArrayDim  */
#line 825 "parser/SysY_parser.y"
{
    (yyval.expressions) = new std::vector<Expression>;
    ((yyval.expressions))->push_back((yyvsp[0].expression));
}
#line 2508 "SysY_parser.tab.c"
    break;

  case 112: /* ArrayDim_list: ArrayDim_list ArrayDim  */
#line 830 "parser/SysY_parser.y"
{
    ((yyvsp[-1].expressions))->push_back((yyvsp[0].expression));
    (yyval.expressions) = (yyvsp[-1].expressions);
}
#line 2517 "SysY_parser.tab.c"
    break;

  case 113: /* ConstArrayDim: '[' ConstExp ']'  */
#line 838 "parser/SysY_parser.y"
{
    (yyval.expression) = (yyvsp[-1].expression);
    (yyval.expression)->SetLineNumber(line_number);
}
#line 2526 "SysY_parser.tab.c"
    break;

  case 114: /* ConstArrayDim_list: ConstArrayDim  */
#line 846 "parser/SysY_parser.y"
{
    (yyval.expressions) = new std::vector<Expression>;
    ((yyval.expressions))->push_back((yyvsp[0].expression));
}
#line 2535 "SysY_parser.tab.c"
    break;

  case 115: /* ConstArrayDim_list: ConstArrayDim_list ConstArrayDim  */
#line 851 "parser/SysY_parser.y"
{
    ((yyvsp[-1].expressions))->push_back((yyvsp[0].expression));
    (yyval.expressions) = (yyvsp[-1].expressions);
}
#line 2544 "SysY_parser.tab.c"
    break;
