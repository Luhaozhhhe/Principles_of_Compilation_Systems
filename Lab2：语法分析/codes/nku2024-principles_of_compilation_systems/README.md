...
=======
# NKU2024-Principles_of_Compilation_Systems
...
```
cd existing_repo
git remote add origin https://gitlab.eduxiji.net/nku2024-compiler-riscv/nku2024-principles_of_compilation_systems.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eduxiji.net/nku2024-compiler-riscv/nku2024-principles_of_compilation_systems/-/settings/integrations)
