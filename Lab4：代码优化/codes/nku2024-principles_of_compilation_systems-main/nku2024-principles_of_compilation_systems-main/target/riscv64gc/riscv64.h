...
private:
    ...
    //return type 1 为I32 type 2为Float32 0为其他
...
public:
    ...
    // example: lui Rd, imm
    RiscV64Instruction *ConstructUImm(int op, Register Rd, long long int imm) {
        RiscV64Instruction *ret = new RiscV64Instruction();
        ret->setOpcode(op, false);
        //std::cout<<OpTable[op].ins_formattype<<std::endl;
